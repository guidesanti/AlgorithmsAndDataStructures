...
public class ImprovedBurrowsWheelerTransform2 implements BurrowsWheelerTransform {

  private static final char EOF = '$';

  @Override
  public String transform(String text) {
    return buildBurrowsWheelerTransform(text, buildSuffixArray(text));
  }

  private String buildBurrowsWheelerTransform(String text, int[] suffixArray) {
