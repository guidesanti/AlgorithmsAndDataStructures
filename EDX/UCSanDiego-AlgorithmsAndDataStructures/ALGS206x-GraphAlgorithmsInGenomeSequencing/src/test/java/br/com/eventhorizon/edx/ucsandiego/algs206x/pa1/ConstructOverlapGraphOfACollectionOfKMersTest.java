...
public class ConstructOverlapGraphOfACollectionOfKMersTest extends PATest {

  private static final String SIMPLE_DATA_SET = "/test-dataset/pa1/construct-overlap-graph-of-a-collection-of-kmers.csv";

  public ConstructOverlapGraphOfACollectionOfKMersTest() {
    super(new ConstructOverlapGraphOfACollectionOfKMers(), true, true);
  }
