...
public class ConstructDeBruijnGraphOfStringTest extends PATest {

  private static final String SIMPLE_DATA_SET = "/test-dataset/pa1/construct-de-bruijn-graph-of-string.csv";

  public ConstructDeBruijnGraphOfStringTest() {
    super(new ConstructDeBruijnGraphOfString(), true, true);
  }
