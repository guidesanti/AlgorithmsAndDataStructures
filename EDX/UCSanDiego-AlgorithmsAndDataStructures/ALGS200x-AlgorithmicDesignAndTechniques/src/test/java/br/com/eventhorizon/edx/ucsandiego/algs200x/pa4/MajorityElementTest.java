...
public class MajorityElementTest extends PATestBase {

  private static final String SIMPLE_DATA_SET = "/test-dataset/pa4/majority-element.csv";

  public MajorityElementTest() {
    super(new MajorityElement(), PATestSettings.builder()
