...
public class FindEulerianPathInGraphTest extends PATestBase {

    private static final String SIMPLE_DATA_SET = "src/test/resources/test-dataset/pa1/find-eulerian-path-in-graph.csv";

    public FindEulerianPathInGraphTest() {
        super(new FindEulerianPathInGraph(), PATestSettings.builder()
