...
public class ConstructDeBruijnGraphOfACollectionOfKMersTest extends PATestBase {

    private static final String SIMPLE_DATA_SET = "src/test/resources/test-dataset/pa1/construct-de-bruijn-graph-of-a-collection-of-kmers.csv";

    private static final String SIMPLE_DATA_SET2 = "/test-dataset/pa1/construct-de-bruijn-graph-of-a-collection-of-kmers.csv";

    public ConstructDeBruijnGraphOfACollectionOfKMersTest() {
        super(new ConstructDeBruijnGraphOfACollectionOfKMers(), PATestSettings.builder()
