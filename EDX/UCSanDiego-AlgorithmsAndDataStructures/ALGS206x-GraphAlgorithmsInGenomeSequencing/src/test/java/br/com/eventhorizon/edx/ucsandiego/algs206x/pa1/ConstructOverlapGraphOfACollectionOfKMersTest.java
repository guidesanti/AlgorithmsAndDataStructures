...
public class ConstructOverlapGraphOfACollectionOfKMersTest extends PATestBase {

    private static final String SIMPLE_DATA_SET = "src/test/resources/test-dataset/pa1/construct-overlap-graph-of-a-collection-of-kmers.csv";

    public ConstructOverlapGraphOfACollectionOfKMersTest() {
        super(new ConstructOverlapGraphOfACollectionOfKMers(), PATestSettings.builder()
