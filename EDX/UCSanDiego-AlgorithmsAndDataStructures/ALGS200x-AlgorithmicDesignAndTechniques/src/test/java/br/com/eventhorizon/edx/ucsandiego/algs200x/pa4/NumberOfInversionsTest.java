...
public class NumberOfInversionsTest extends PATestBase {

  private static final String SIMPLE_DATA_SET = "/test-dataset/pa4/number-of-inversions.csv";

  public NumberOfInversionsTest() {
    super(new NumberOfInversions(), PATestSettings.builder()
